...
(() => {
    window.LAYOUT_EN_QWERTY = {
        ...
        fingerMap: {
            ...
            '0':'right-pinky','p':'right-pinky',';':'right-pinky','/':'right-pinky','[':'right-pinky',']':'right-pinky','\\':'right-pinky','-':'right-pinky','=':'right-pinky','Backspace':'right-pinky','Enter':'right-pinky',"'":'right-pinky',
            ' ':'thumb'
        }
    };
})();
